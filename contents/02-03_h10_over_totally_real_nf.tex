...
%TODO How? Maybe using the strong approximation theorem?
\todo{How? Maybe using the strong approximation theorem?}
...
Finally, we have all the tools at hand to present a Diophantine repersentation
of \(ℤ\) over \(\algint\).
