...
\begin{exam}
  Consider the number field \(K := ℚ\left[√2\right]\). It is not hard to check
  that \(\set{1, √2}\) is an integral basis for \(\algint\). We may choose \(a =
  2\) as the integer in the definition of the sequences. Indeed, we find \(δ =
...
\begin{proof}
  ...
  x', y\) and \(y'\) can be satisfied by \cref{lem:a exists}.
  By \cref{lem:forcing divisibility} we can
