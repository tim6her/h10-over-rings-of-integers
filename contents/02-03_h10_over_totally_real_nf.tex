...
Davis proofs that a function is Diophantine if and only if it is
computable~\cite[Thm 6.1]{Davis1973}.

This already implies the \textsc{DPRM}-theorm~(\ref{thm:DPRM}) as Davis has
...
the semi-decidable subsets of \(ω\) by \cref{pro:characterizations of ce sets},
