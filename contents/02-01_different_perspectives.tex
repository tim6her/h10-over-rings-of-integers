...
Robinson\todo{Find reference, see Königsmann Sec. 3.3}{} that
$\mathtt{Th}(\mathfrak O)$ is undecidable. However, Rumley\todo{Find
reference}{} proved that \textsc{H10} is solvable for $\overset{ℤ}$ the ring of
all algebraic integers. Van den Dries\todo{find reference}{} extended this
