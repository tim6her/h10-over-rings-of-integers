...
by a \foreignquote{german}{Verfahren \textins{mit} einer endlichen Anzahl von
Operationen%
...
At second sight the construction is even less surprising, as for every ring with
