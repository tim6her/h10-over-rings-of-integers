...
\begin{exam}
  \begin{exlist}
    ...
    Let now \(α ≠ 0\). We can find ideals \(\mathfrak x_2, \mathfrak x_3\) such
    that \((α) = \mathfrak x_2 \mathfrak x_3\) and \((2) + \mathfrak x_2 =
    \algint\), \((3) + \mathfrak x_3 = \algint\) as well as \(\mathfrak x_2 +
    \mathfrak x_3 = \algint\). This is because \(2\) and \(3\) are rational
    primes and therefore \((2)\) and \((3)\) are relative prime.
    % see Baxa Thm 120
     As a consequence of the Chinese remainder
     theorem~\cite[see][3.6]{Neukirch2006} the congruences
    \[
      2 β_2 \equiv 1 \mod \mathfrak x_2 \quad \text{and} \quad
      3 β_2 \equiv 1 \mod \mathfrak x_3
    \]
    are simultaneously solvable. Therefore there exists an algebraic integer
    \(β_2 ∈ \algint\) such that
    \[
      2 β_2 - 1 ∈ \mathfrak x_2  \quad \text{and} \quad
      3 β_2 - 1 ∈ \mathfrak x_3.
    \]
    As a consequence, \((2 β_2 - 1)(3 β_2 - 1)\) is contained in \(\mathfrak x_2
    \mathfrak x_3 = (α)\), or put differently, there exists a \(β_2 ∈ \algint\)
    such that
    \[
      α β_1 = (2 β_2 - 1)(3 β_3 - 1)
    \]
