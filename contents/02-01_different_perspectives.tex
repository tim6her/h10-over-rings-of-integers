...
the Diophantine sets of (3), (4), and (5) are in fact purely Diophantine, whilst
finite sets (1) are in general not. As for polynomial functions \(p: R^n → R\),
...
Diophantine sets. However, the analogue of \cref{lem:intersections and unions}
holds for purely Diophantine sets.
\begin{lem}
...
\begin{proof}
  ...
  Y)\) is bivariat. The general case follows analogously.
