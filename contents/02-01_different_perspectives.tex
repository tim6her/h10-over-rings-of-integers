...
\begin{exam}\label{ex:Diophantine sets}
  \begin{exlist}
    ...
    \item Let \(K\) be a number field and \(\algint\) its ring of algebraic
    ...
    Let \(R\) be a commutative ring with unity. The set of units \(U\) in \(R\) is Diophantine over \(R\). This can be seen by the polynomial equation
    \[
