...
\begin{proof}
  ...
  function, whose domain is \(Q\). For each integer \(n ∈ ℕ\), I denote by
  \(\mathbb{A}_n\) the set of all strings \(x := b_1…b_k ∈ ω\) such that \(k ≤
  n\) and \(\mathbb{A}\) halts on \(x\) in at most \(n\) steps of the
  computation.
