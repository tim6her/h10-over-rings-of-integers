...
\begin{figure}
  ...
  \label{fig:Pinocchio}
\end{figure}
\footnotetext{As Carlo Chiostri died in 1939, this work is in the public domain
in its country of origin (Italy) and other countries and areas where the
copyright term is the author's life plus 70 years or less. In particular, it is
in the public domain in Austria.}
