...
\begin{defin} \todo{use definition 1.1.1 of \cite{Stoltenberg1999}}
...
\begin{exam}
  \begin{exlist}
    ...
    \item In general $ℤ$ and $\algint$ viewed as $\mathcal L_{ring}^*$ structures are efficiently presentable. For the integers this is proven by each programming language allowing arbitrarily large integer arithmetic---like \emph{Haskell} or \emph{Python}.
...
$\mathcal{L}_{ring}^*$-structure of $R_1$ and $\mathfrak R_2$ the respective
