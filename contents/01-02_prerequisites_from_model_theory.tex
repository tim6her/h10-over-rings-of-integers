...
Of special interest to us is the Diophantine theory of rings with unity. The name
...
\begin{lem}\label{lem:properties of Goedelization}
  Properties of the Gödelization
  %TODO
  \todo{properties of Gödelization}
\end{lem}
...
\begin{lem}\label{lem:H10 is semi decidable}
  Let \(R\) be a computable, commutative ring with unity and \(\mathfrak{R}\) its
